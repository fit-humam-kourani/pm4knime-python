...
public class BpmnWriterNodeDialog extends NodeDialogPane {

	DialogComponentWriterFileChooser m_filePanel;
    private BpmnWriterNodeModel model;
	private static final String FILE_HISTORY_ID = "Bpmn_reader_writer";
	
	
    protected BpmnWriterNodeDialog(final NodeCreationConfiguration creationConfig, BpmnWriterNodeModel model) {
    	this.model = model;
